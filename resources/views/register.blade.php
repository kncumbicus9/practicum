...
<label for="basic-url" class="form-label">Ingrese nombres</label>
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon3">Nombres: </span>
  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
</div>

<label for="basic-url" class="form-label">Ingrese apellidos</label>
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon3">Apellidos: </span>
  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
</div>

<label for="basic-url" class="form-label">Ingrese el Mail</label>
<div class="input-group mb-3">
...
<label for="basic-url" class="form-label">Ingrese la clave</label>
<div class="input-group mb-3">
